...
export class PurchaseViewComponent implements OnInit {
  ...
  onAddEnquiry() {
    this.testEntry = {
      ...
      "po_date": this.PurchaseOrderService.selectedPurchaseorderService.po_date,
      "pr_number": this.newPurchase_id,
      ...
      "created_by": "Jack",
      "created_date": this.PurchaseOrderService.selectedPurchaseorderService.created_date,
      "uploaded_by": "Jack",
